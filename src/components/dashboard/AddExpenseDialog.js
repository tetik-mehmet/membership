...
export default function AddExpenseDialog({ children }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        router.refresh();
        toast.success('Harcama eklendi', { description: 'Yeni harcama kaydı oluşturuldu.' });
      } else {
        toast.error('Harcama eklenemedi', { description: data.error || 'Lütfen bilgileri kontrol edin.' });
      }
    } catch (error) {
